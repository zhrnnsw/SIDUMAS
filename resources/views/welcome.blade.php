    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400">Sampaikan laporan masalah infrastruktur di sini, 
            kami akan memprosesnya dengan cepat , aman dan nyaman.</h2>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            <p>
              <h3>SIDUMAS</h3> adalah sistem pengaduan Masyarakat yang dibuat untuk memudahkan 
              Masyarakat untuk memberikan laporan atau informasi terkait infrastruktur kepada Dinas PUPR Kab. Malang
            </p>
            <ul>
              <h3>Tujuan SIDUMAS</h3>
              <li><i class="ri-check-double-line"></i>Memudahkan masyarakat memantau proses tindak lanjut dari pengaduan terkait infrastruktur</li>
              <li><i class="ri-check-double-line"></i>Memudahkan Dinas PUPR Kab. Malang menyampaikan proses tindak 
              lanjut dari pengaduan yang disampaikan masyarakat.</li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <p>
              <h4>SIDUMAS</h4>merupakan komitmen  kami untuk melayani masyarakat. Dengan hadirnya sistem pelaporan pengaduan online ini, 
              diharapkan setiap suara masyarakat bisa didengar dan ditindaklanjuti oleh Dinas PUPR Kab. Malang.
            </p>
              ...
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p><strong>Pengguna</strong><br>Jumlah pengguna SIDUMAS</p>
                  </div>
                </div>
